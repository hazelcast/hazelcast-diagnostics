...
import static com.hazelcast.diagnostics.InstanceDiagnostics.DiagnosticType.TYPE_WAN;
...
public class WANPane {
    ...
    public void update() {
        ...
        for (InstanceDiagnostics diagnostics : diagnosticsList) {
            Iterator<Map.Entry<Long, String>> iterator = diagnostics.between(TYPE_WAN, startMs, endMs);
